...
public class EmployeeDAOImpl implements EmployeeDAO{
	...
	private String GET_CUSTOMER_BALANCE="call banking.getCustomerBalance(?,?)";
	private String LOAD_CUSTOMER_BANK_ACCOUNTS="select * from banking.customers";
	private String LOAD_CUSTOMER_DETAILS="select * from banking.customers where accountNumber=?";
	private String VALIDATE_EMPLOYEE="select employeeUserName,employeePassword from banking.employee where employeeUserName=? and employeePassword=? ";
	private String GET_EMPLOYEE_NAME="select employeeFirstName,employeeLastName from banking.employee where employeeUserName=?";
	private String VALIDATE_CUSTOMER="select customerFirstName from banking.customers where accountNumber=?";
	private String GET_CIF_ID="select customerCifId from banking.customers where accountNumber=?";
	private String UPDATE_CIF_ID="update banking.customers set customerCifId=? where accountNumber=?";
